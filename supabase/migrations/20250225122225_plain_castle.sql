...
-- Policies for admin views
ALTER VIEW admin_dashboard_stats OWNER TO authenticated;
ALTER VIEW admin_user_activities OWNER TO authenticated;

GRANT SELECT ON admin_dashboard_stats TO authenticated;
GRANT SELECT ON admin_user_activities TO authenticated;

-- RLS policies for admin functions
CREATE POLICY "Admins can access school stats"
  ON schools
  FOR ALL
  TO authenticated
  USING (
